...
export const SystemPulse = () => {
	...
	return (
		<Terminal title="System Pulse Monitor" className="h-[300px]">
			<div className="h-full overflow-x-auto overflow-y-hidden">
				<div className="space-y-1 min-w-max pr-4">
					...
					{pulseEvents.map((event, i) => (
						...
						>
							...
							<span className={`${getTypeColor(event.type)} font-bold whitespace-nowrap`}>
								[{event.type}]
							</span>
